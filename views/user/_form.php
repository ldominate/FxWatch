		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<?php if(!$model->isNewRecord): ?>
					<?= $form->field($model, 'updated_at')->textInput(['readonly' => true, 'value' => Yii::$app->formatter->asDatetime($model->updated_at)]) ?>

					<?= $form->field($model, 'created_at')->textInput(['readonly' => true, 'value' => Yii::$app->formatter->asDatetime($model->created_at)]) ?>
				<?php endif;?>
