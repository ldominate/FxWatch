...
class m171118_044703_create_finam_settings extends Migration
{
    public function safeUp()
    {
		...
		[
	        ['http://export.finam.ru/', 5, 83, 'EURUSD', 0, '01.01.0000', '01.01.0000', 4, 'EURUSD_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 5, 86, 'GBPUSD', 0, '01.01.0000', '01.01.0000', 4, 'GBPUSD_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 5, 87, 'USDJPY', 0, '01.01.0000', '01.01.0000', 4, 'USDJPY_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 5, 85, 'USDCHF', 0, '01.01.0000', '01.01.0000', 4, 'USDCHF_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 5, 66699, 'AUDUSD', 0, '01.01.0000', '01.01.0000', 4, 'AUDUSD_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 5, 181425, 'NZDUSD', 0, '01.01.0000', '01.01.0000', 4, 'NZDUSD_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 5, 66700, 'USDCAD', 0, '01.01.0000', '01.01.0000', 4, 'USDCAD_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 5, 901, 'USDRUB', 0, '01.01.0000', '01.01.0000', 4, 'USDRUB_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],

			['http://export.finam.ru/', 6, 90, 'SANDP-500', 0, '01.01.0000', '01.01.0000', 4, 'SANDP-500_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 6, 91, 'D&J-IND', 0, '01.01.0000', '01.01.0000', 4, 'D&J-IND_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 6, 82075, 'NASDAQCOMP', 0, '01.01.0000', '01.01.0000', 4, 'NASDAQCOMP_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 6, 93, 'FUTSEE-100', 0, '01.01.0000', '01.01.0000', 4, 'FUTSEE-100_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 6, 112, 'CAC40', 0, '01.01.0000', '01.01.0000', 4, 'CAC40_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 6, 19063, 'N225JAP', 0, '01.01.0000', '01.01.0000', 4, 'N225JAP_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 6, 111, 'ZHC5', 0, '01.01.0000', '01.01.0000', 4, 'ZHC5_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0],
			['http://export.finam.ru/', 6, 19101, 'SHANGHAI', 0, '01.01.0000', '01.01.0000', 4, 'SHANGHAI_01010000', '.csv', 1, 1, 0, 0, 1, 2, 1, 0, 0]
		]);
